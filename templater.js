...
//     run: function() {
//         let oldTag = document.getElementsByTagName('bootstrap_button');
...
//     run: function() {
//         let allElements;
//         for (let i = 0; i < this.tagRepo.length; i++) {
//             allElements = document.getElementsByTagName(this.tagRepo[i]);
//             let HtmlArr = Array.from(allElements);
//             console.log(HtmlArr);
...
//             for (let j = 0; j < HtmlArr.length; j++) {
//               let types = HtmlArr[j].getAttribute('type');
//               let classes = HtmlArr[j].getAttribute('class');
//               let text = HtmlArr[j].innerHTML;
//               element[0].push(types);
//               element[1].push(classes);
//               element[2].push(text);
//               let newTemplate = this.render(this.tmplRepo[i],this.ElementsArr[i],i,j);
